...
public interface ApiInterface {
    ...
    Call<Message> sendMessagesToGroup(@Path("groupId") Long groupId,@Body Map<String,String> text,@Body Map<String,Boolean> emergency);

    //New message to the ‘parents’ of a user:
    @POST ("/messages/toparentsof/{userId}")
    Call<Message> sendMessagesToParentOfUser(@Path("userId") Long UserID,@Body Map<String,String> text,@Body Map<String,Boolean> emergency);
